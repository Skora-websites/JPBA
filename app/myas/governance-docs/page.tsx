...
export default function GovernanceDocsPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#FDF8EF]">
      ...
      <PageHeader title="Governance Docs" image="/boccia1.png" breadcrumb={[{"label":"MYAS Disclosures"},{"label":"Governance"}]} 
      />
      ...
      <main className="flex-1 py-16">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          >
            <h2 className="text-3xl font-bold text-[#0A2F1D] mb-6">Governance Docs</h2>
            <div className="prose max-w-none text-gray-600">
              <p className="text-lg leading-relaxed mb-4">
                Welcome to the Governance Docs section of the Jharkhand Para Boccia Association. 
