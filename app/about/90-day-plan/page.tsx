      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#D4AF37] text-[11px] font-bold tracking-[0.3em] uppercase mb-3">DEVELOPMENT</p>
                <h1 className="text-[36px] sm:text-[44px] font-bold text-[#1B5E20] leading-tight mb-4">90-Day Development Plan</h1>
              ...
              <div className="hidden lg:block">
                <div className="rounded-2xl overflow-hidden shadow-xl border border-[#D4AF37]/20">
                  <img src="https://images.unsplash.com/photo-1564769662533-4f00a87b4056?w=800&q=80" alt="90-Day Development Plan" className="w-full h-[350px] object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="mx-auto max-w-[1000px] px-6 lg:px-10">
            <h2 className="text-[28px] font-bold text-[#1B5E20] mb-8">JPBA 90-Day Development Plan</h2>
            <div className="space-y-8">
              {[{ phase: "MAP", days: "Days 1-30", color: "forest", items: ["District leads", "Athlete mapping", "Venue assessment", "Clinician partnerships", "Equipment procurement", "Safeguarding protocols"] },
                ...
                <div key={p.phase} className="rounded-xl border border-[#D4AF37]/20 overflow-hidden">
