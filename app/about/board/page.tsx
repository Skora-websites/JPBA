      ...
      <main className="flex-1 py-16 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 relative z-10">
          ...
          <ScrollReveal variant="fade-up">
            <h2 className="text-3xl font-bold text-[#0A2F1D] mb-2">Office Bearers</h2>
          ...
          {/* Coach — full profile */}
          <ScrollReveal variant="fade-up">
            <h2 className="text-3xl font-bold text-[#0A2F1D] mb-2">National Coach</h2>
            <div className="w-16 h-1 bg-[#C9A84C] rounded-full mb-10" />
          </ScrollReveal>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-[#C9A84C]/20 overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="lg:col-span-3 p-8 md:p-10">
                  <h3 className="text-[26px] font-bold text-[#0A2F1D] leading-tight">
                    Raj Kumar Singh
                  </h3>
                  ...
                  <p className="text-[#5C5C5C] text-[14px] leading-relaxed mb-4">
                    Raj Kumar Singh is a sports professional and disability-sports
                    activist from Jamshedpur, actively associated with the
                    development and promotion of Blind Football and sports for
                    persons with disabilities. His work spans grassroots player
                    development, sports camps, competitions and support for
                    athletes at national-level events — including preparing the
                    Jharkhand Blind Football Team for the Greater Lions Vision
                    Cup 2025, where Jharkhand finished 2nd Runner-up.
                  </p>
                  ...
                  <div className="border-t border-[#E2D9C8] pt-5">
                    ...
                    <p className="text-[13px] text-[#5C5C5C] leading-relaxed mb-4">
                      To create greater opportunities for persons with visual
                      impairment and other disabilities through sports, training,
                      skill development and participation at national and
