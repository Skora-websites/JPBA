          ...
          <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-[36px] sm:text-[44px] font-bold text-[#1B5E20] leading-tight mb-4">Mission &amp; Purpose</h1>
              ...
              <div className="hidden lg:block">
                <div className="rounded-2xl overflow-hidden shadow-xl border border-[#D4AF37]/20">
                  <img src="https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&q=80" alt="Mission" className="w-full h-[350px] object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="mx-auto max-w-[1200px] px-6 lg:px-10">
            <div className="bg-white rounded-2xl p-10 shadow-lg border border-[#D4AF37]/10 mb-12">
              <h2 className="text-2xl font-bold text-[#1B5E20] mb-6">Our Mission</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#D4AF37]/10">
                <h3 className="text-xl font-bold text-[#1B5E20] mb-4">Core Purpose</h3>
                <ul className="space-y-3">
                  {["Create awareness of Boccia across Jharkhand","Identify athletes with potential through school and hospital demonstrations","Provide coaching, classification, and competitive opportunities","Build a sustainable pathway from grassroots to national and international competition","Develop coaches, officials, and support personnel","Create partnerships with government, corporate, and community organisations"].map((item,i)=>(
                    <li key={i} className="flex items-start gap-3 text-gray-700"><span className="w-2 h-2 rounded-full bg-[#D4AF37] mt-2 flex-shrink-0"></span><span>{item}</span></li>
                  ))}
                </ul>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#D4AF37]/10">
                <h3 className="text-xl font-bold text-[#1B5E20] mb-4">Our Commitment</h3>
                <ul className="space-y-3">
            ...
            <div className="bg-[#1B5E20] rounded-2xl p-10 text-white text-center">
