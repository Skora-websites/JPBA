    ...
    <div className="flex flex-col min-h-screen bg-[#FDF8EF]">
      ...
      <main className="flex-1">
        <section className="relative pt-[230px] pb-16 min-h-[320px] border-b border-[#C9A84C]/20" style={{background: "linear-gradient(135deg, #0A2F1D 0%, #133824 40%, #1B4E33 100%)"}}>
          <img src="/jpba images/FullSizeRender 18.jpeg" alt="" className="absolute inset-0 w-full h-full object-cover" />
...
<div className="mx-auto max-w-[1400px] px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#B8923A] text-[11px] font-bold tracking-[0.3em] uppercase mb-3">PATHWAY</p>
                <h1 className="text-[36px] sm:text-[44px] font-bold text-[#0A2F1D] leading-tight mb-4">Competition Pathway</h1>
                <p className="text-[15px] text-gray-600 max-w-[600px] leading-relaxed">From local discovery through Paralympic competition â€” the complete athlete journey.</p>
              </div>
              <div className="hidden lg:block">
                <div className="rounded-2xl overflow-hidden shadow-xl border border-[#C9A84C]/20">
                  <img src="/jpba images/FullSizeRender 18.jpeg" alt="Competition Pathway" className="w-full h-[350px] object-cover" />
                </div>
              </div>
            </div>
          </div>
