    ...
    <div className="flex flex-col min-h-screen bg-[#F5F5DC]">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#D4AF37] text-[11px] font-bold tracking-[0.3em] uppercase mb-3">THE SPORT</p>
                <h1 className="text-[36px] sm:text-[44px] font-bold text-[#1B5E20] leading-tight mb-4">What is Boccia?</h1>
              ...
              <div className="hidden lg:block">
                <div className="rounded-2xl overflow-hidden shadow-xl border border-[#D4AF37]/20">
                  <img src="https://images.unsplash.com/photo-1564769662533-4f00a87b4056?w=800&q=80" alt="What is Boccia?" className="w-full h-[350px] object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="mx-auto max-w-[1000px] px-6 lg:px-10">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-[28px] font-bold text-[#1B5E20] mb-6">What is Boccia?</h2>
        ...
        <section className="py-16 bg-[#F5F5DC] border-t border-[#D4AF37]/20">
          <div className="mx-auto max-w-[1000px] px-6 lg:px-10">
            <h2 className="text-[28px] font-bold text-[#1B5E20] mb-6">How the Game Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="rounded-xl bg-white border border-[#D4AF37]/20 p-6">
                <h3 className="text-[18px] font-bold text-[#1B5E20] mb-3">Individual</h3>
                <p className="text-[14px] text-gray-600">4 ends, 6 balls per player per end</p>
              </div>
              <div className="rounded-xl bg-white border border-[#D4AF37]/20 p-6">
                <h3 className="text-[18px] font-bold text-[#1B5E20] mb-3">Pairs</h3>
                <p className="text-[14px] text-gray-600">4 ends, 6 balls per pair per end (3 per player)</p>
              </div>
              <div className="rounded-xl bg-white border border-[#D4AF37]/20 p-6">
                <h3 className="text-[18px] font-bold text-[#1B5E20] mb-3">Team</h3>
                <p className="text-[14px] text-gray-600">6 ends, 6 balls per team per end (2 per player)</p>
              </div>
              <div className="rounded-xl bg-white border border-[#D4AF37]/20 p-6">
                <h3 className="text-[18px] font-bold text-[#1B5E20] mb-3">Tie-Break</h3>
        ...
        <section className="py-16 bg-white border-t border-[#D4AF37]/20">
          <div className="mx-auto max-w-[1000px] px-6 lg:px-10">
            <h2 className="text-[28px] font-bold text-[#1B5E20] mb-6">Pronunciation & Origin</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl bg-[#F5F5DC] border border-[#D4AF37]/20 p-6 text-center">
                <p className="text-[24px] font-bold text-[#1B5E20] mb-2">/ˈbɒtʃə/</p>
                <p className="text-[14px] text-gray-400">BOTCH-uh</p>
              </div>
              <div className="rounded-xl bg-[#F5F5DC] border border-[#D4AF37]/20 p-6 text-center">
                <p className="text-[24px] font-bold text-[#1B5E20] mb-2">Latin</p>
                <p className="text-[14px] text-gray-400">From "bottia" meaning boss</p>
              </div>
              <div className="rounded-xl bg-[#F5F5DC] border border-[#D4AF37]/20 p-6 text-center">
                <p className="text-[24px] font-bold text-[#1B5E20] mb-2">1984</p>
