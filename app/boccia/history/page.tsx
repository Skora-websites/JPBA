    ...
    <div className="min-h-screen bg-[#F5F5DC]">
      ...
      <section className="relative py-20 overflow-hidden" style={{background: "linear-gradient(135deg, #F5F5DC 0%, #FFFFFF 50%, #E8F5E9 100%)"}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#1B5E20] mb-4">History &amp; Paralympic Context</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-[#1B5E20] mb-8">Timeline</h2>
          <div className="relative">
            <div className="absolute left-5 top-0 bottom-0 w-0.5 bg-[#D4AF37]/30"></div>
            <div className="space-y-8">
              {steps.map((step, i) => (
                <div key={i} className="flex gap-6 items-start">
                  <div className="w-10 h-10 rounded-full bg-[#D4AF37] text-white flex items-center justify-center font-bold text-sm flex-shrink-0 z-10">{step.year}</div>
                  <div className="bg-white rounded-xl p-6 shadow-md border border-[#D4AF37]/10 flex-1">
        ...
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-[#1B5E20] mb-6">Governance</h2>
