  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FDF8EF]">
      ...
      <main className="flex-1">
        {/* Hero */}
                <PageHero
          image={PAGE_HERO.athletes}
          imageAlt="A JPBA athlete competing on game day"
          eyebrow="OUR PLAYERS"
          title={"Meet the Athletes"}
          description="The verified players representing Jharkhand in national and international Para Boccia."
          breadcrumb={[{"label": "Athletes"}]}
          size={"lg"}
          reverse
        />
