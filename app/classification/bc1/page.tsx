      ...
      <section className="relative py-20 overflow-hidden" style={{background: "linear-gradient(135deg, #F5F5DC 0%, #FFFFFF 50%, #E8F5E9 100%)"}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 rounded-xl bg-[#D4AF37] text-white flex items-center justify-center text-2xl font-bold">BC1</div>
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-[#1B5E20]">BC1</h1>
