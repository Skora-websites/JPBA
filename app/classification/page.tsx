...
<div className="mx-auto max-w-[1400px] px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#B8923A] text-[11px] font-bold tracking-[0.3em] uppercase mb-3">ELIGIBILITY</p>
              ...
              <div className="hidden lg:block">
                <div className="rounded-2xl overflow-hidden shadow-xl border border-[#C9A84C]/20">
                  <img src="/images/dsc06706.webp" alt="Who Can Play?" className="w-full h-[350px] object-cover" />
                </div>
              </div>
            </div>
          </div>
